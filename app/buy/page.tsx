...
export default function BuyPage() {
  return (
    <div style={{ backgroundColor: "#ffffff" }}>
      ...
      {/* ヒーロー画像（フルワイド・プレースホルダー） */}
      <div style={{ position: "relative", width: "100%", height: "clamp(240px, 40vw, 460px)", overflow: "hidden", marginTop: "24px", backgroundColor: "#E8F0E8", display: "flex", alignItems: "center", justifyContent: "center" }}>
        <p style={{ color: "#aaa", fontSize: "13px" }}>ヒーロー画像（/images/buy/buyhero.jpg）</p>
      </div>
      ...
      <section style={{ padding: "64px 0" }}>
        <div className="container-content">
          ...
          <p style={{ fontSize: "14px", color: "#555", lineHeight: 1.9, marginBottom: "48px" }}>
            不動産は安い買い物ではありません。だからこそ慎重にご検討いただき、納得されたうえで購入していただきたいと考えています。フェリアホームでは全社員が宅地建物取引士の資格を所持。専任の担当スタッフが不動産探しから重要事項説明まで一貫して行っているため、ご契約時に「聞いていない」等のトラブルは一切ありません。お客様にとってかけがえのない不動産探しは、スタッフが不動産の有資格者であるフェリアホームにお任せください。
          </p>
              ...
              <div key={step.num}>
                <div style={{
                  ...
                  <div style={{
                    ...
                    borderRadius: "6px", backgroundColor: "#E8F0E8",
                    display: "flex", alignItems: "center", justifyContent: "center",
                  }}>
                    <span style={{ fontSize: "10px", color: "#aaa" }}>{step.imgFile}.jpg</span>
                  </div>
                  <div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "32px" }}>
            {POINTS.map((point) => (
              <div key={point.num} style={{ display: "grid", gap: "24px", alignItems: "start" }}
                ...
                <div style={{
                  width: "100%", maxWidth: "180px", aspectRatio: "4/3",
                  borderRadius: "8px", backgroundColor: "rgba(255,255,255,0.15)",
                  display: "flex", alignItems: "center", justifyContent: "center",
                }}>
                  <span style={{ color: "rgba(255,255,255,0.4)", fontSize: "11px" }}>{point.imgFile}.jpg</span>
                </div>
                <div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "16px", marginBottom: "32px" }}
            ...
            {ONLINE_STEPS.map((s) => (
              <div key={s.num} style={{ border: "1px solid #E5E5E5", borderRadius: "8px", overflow: "hidden", width: "100%" }}>
                ...
                <div style={{ height: "80px", backgroundColor: "#E8F0E8", display: "flex", alignItems: "center", justifyContent: "center" }}>
                  <span style={{ fontSize: "10px", color: "#aaa" }}>写真</span>
                </div>
